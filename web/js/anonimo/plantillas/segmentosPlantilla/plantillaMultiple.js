...
$(document).ready(function () {
	//Inicializamos el plugin de background
	$('body').backGroundAnimation({defaultElement:'queEsLaGuantera',
                                           defaultContentId:'contenido',
                                           jSonBackGroundPosition:'{"queEsLaGuantera":"-1900px -903px","planificaTuViaje":"-300px -250px","galeriaImagenes":"-270px -1560px","gestionGastos":"-3500px -970px","notificaciones":"-1960px -1600px","recuperarContrasena":"-3500px -250px","registrarse":"-713px -1279px","contactar":"-900px -30px","politicaPrivacidad":"-298px -200px","mapaWeb":"-1000px -50px","w3c":"-100px -1000px"}',
                                           divClassFadeOut:'Ocultar',
                                           divClassFadeIn:'Mostrar',
                                           divs:["menu","cabecera"],
                                           speedBackgroudAnimation:'2000',
                                           speedHeight:'500',
	...
	$('#menu').slideMenuEffect({selectedClassBox:'MenuDeslizante'});
        
	//Iniciamos el widget del formulario
	$("#formularioPlanificaTuViaje").formwizard({
                linkClass:'Button Small Blue',
                submitStepClass:'Button Small Blue',
		textNext:'Siguiente',
		textBack:'Anterior',
		textSubmit:'Calcular',
